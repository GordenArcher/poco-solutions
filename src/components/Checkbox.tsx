...
const Checkbox = ({ IsChecked, setIsChecked }: { IsChecked: boolean,  setIsChecked: Dispatch<SetStateAction<boolean>>}) => {
  return (
    <StyledWrapper>
      <label className="container">
        <input title='check' type="checkbox" checked={IsChecked} onChange={() => setIsChecked((prevState) => !prevState)} />
